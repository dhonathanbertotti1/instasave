      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg instagram-gradient flex items-center justify-center flex-shrink-0">
            ...
            <span className="text-sm font-semibold text-white">InstaDownloader</span>
          </div>
